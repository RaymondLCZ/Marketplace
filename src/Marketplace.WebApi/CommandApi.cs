...
public abstract class CommandApi<T> : ControllerBase where T : AggregateRoot
{
    readonly ILogger _log;

    protected CommandApi(ApplicationService<T> applicationService, ILoggerFactory loggerFactory)
    {
